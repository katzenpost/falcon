...
// by PQClean in crypto_sign/falcon-padded-512/META.yml. It pins our
// implementation against PQClean's reference.
const nistKATSha256 = "91842d41138e7cfaf6e2e8f12a03c3b3411302255121e4d07d02f91a003c0395"
...
func TestNistKAT(t *testing.T) {
	...
	if !padded512.Verify(&pk, msg, sig) {
